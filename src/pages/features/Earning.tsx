...
export function EarningView({ onBack }: EarningViewProps) {
  ...
  if (activeSubView === "candy-crush") {
    return <CandyCrushGame onBack={() => setActiveSubView(null)} />;
  }

  if (activeSubView === "tic-tac-toe") {
    return <TicTacToeGame onBack={() => setActiveSubView(null)} />;
  }

  if (activeSubView === "all-games") {
    return <AllGamesView 
             onBack={() => setActiveSubView(null)} 
             onSelectGame={(game) => {
               setActiveSubView(game);
          ...
          <div className="pl-6 pb-2 pt-2">
            <div className="flex items-center justify-between pr-6 mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-black text-slate-800 dark:text-slate-200 uppercase tracking-wider flex items-center gap-1 flex-wrap">
                  Community <span className="opacity-50 mx-1">|</span>{" "}
                  {language === "bn" ? "প্রতিদিন গেম খেলুন" : "Play daily games"}
                </h3>
              </div>
              <button 
                onClick={() => {
                  setActiveSubView("all-games");
                  window.history.pushState({ view: "all-games" }, "");
                }}
                className="px-3 py-1.5 border-2 border-slate-200 dark:border-slate-700 rounded-lg text-[10px] sm:text-xs font-bold text-slate-600 dark:text-slate-400 active:scale-95 transition-transform shrink-0"
              >
                {language === "bn" ? "সি অল" : "See All"}
              </button>
            </div>
            ...
            {/* Banner Cards */}
            <div className="flex gap-4 overflow-x-auto pr-6 pb-8 pt-2 snap-x hide-scrollbar">
              {/* Sudoku Card */}
              <div
                className="min-w-[85%] sm:min-w-[320px] bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/30 dark:to-yellow-800/20 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between group cursor-pointer border border-yellow-200 dark:border-yellow-700/50 shadow-sm aspect-video snap-center"
              ...
              {/* Candy Match Card */}
              <div
                className="min-w-[85%] sm:min-w-[320px] bg-gradient-to-r from-pink-100 to-rose-100 dark:from-pink-900/30 dark:to-rose-800/20 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between group cursor-pointer border border-pink-200 dark:border-rose-700/50 shadow-sm aspect-video snap-center"
                onClick={() => setActiveSubView("candy-crush")}
              >
                {/* Background gradient/decorations */}
                <div className="absolute top-0 right-0 w-48 h-48 bg-pink-300/40 rounded-full -mr-16 -mt-16 blur-3xl pointer-events-none group-hover:bg-pink-300/60 transition-colors" />
                <div className="absolute top-4 right-4 text-6xl opacity-40 drop-shadow-md -rotate-12 transition-transform group-hover:-rotate-6 group-hover:scale-110">
                  🍬
                </div>
                ...
                <div className="relative z-10 flex flex-col gap-2 max-w-[65%]">
                  ...
                  <div className="text-[10px] font-bold text-slate-700 dark:text-slate-200 mt-2 bg-pink-200/80 dark:bg-rose-700/50 py-1.5 px-2.5 rounded-md self-start inline-flex items-center gap-1.5 border border-pink-300 dark:border-rose-600/50 shadow-sm">
                    {language === "bn" ? "কোন কয়েন নেই" : "No coins awarded"}
                  </div>
                </div>
                ...
                <div className="relative z-10 mt-6 flex justify-end">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      setActiveSubView("candy-crush");
                    }}
                    className="bg-rose-500 hover:bg-rose-600 text-white px-5 py-2.5 rounded-full font-bold text-sm shadow-lg active:scale-95 transition-all flex items-center gap-1.5 shadow-rose-500/30 uppercase tracking-widest"
                  >
                    {language === "bn" ? "প্লে নাউ" : "Play Now"}{" "}
                    <ChevronRight className="w-4 h-4 ml-1" />
                  </button>
              ...
              {/* Tic Tac Toe Card */}
              <div
                className="min-w-[85%] sm:min-w-[320px] bg-gradient-to-r from-cyan-100 to-blue-100 dark:from-cyan-900/30 dark:to-blue-800/20 rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between group cursor-pointer border border-cyan-200 dark:border-blue-700/50 shadow-sm aspect-video snap-center"
                onClick={() => setActiveSubView("tic-tac-toe")}
              >
                {/* Background gradient/decorations */}
                <div className="absolute top-0 right-0 w-48 h-48 bg-cyan-300/40 rounded-full -mr-16 -mt-16 blur-3xl pointer-events-none group-hover:bg-cyan-300/60 transition-colors" />
                <div className="absolute top-4 right-4 text-6xl opacity-40 drop-shadow-md rotate-12 transition-transform group-hover:rotate-6 group-hover:scale-110">
                  ⭕
                </div>
                ...
                <div className="relative z-10 flex flex-col gap-2 max-w-[65%]">
                  ...
                  <div className="text-[10px] font-bold text-slate-700 dark:text-slate-200 mt-2 bg-cyan-200/80 dark:bg-cyan-700/50 py-1.5 px-2.5 rounded-md self-start inline-flex items-center gap-1.5 border border-cyan-300 dark:border-cyan-600/50 shadow-sm">
                    {language === "bn" ? "কোন কয়েন নেই" : "No coins awarded"}
                  </div>
                </div>
                ...
                <div className="relative z-10 mt-6 flex justify-end">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      setActiveSubView("tic-tac-toe");
                    }}
                    className="bg-cyan-500 hover:bg-cyan-600 text-white px-5 py-2.5 rounded-full font-bold text-sm shadow-lg active:scale-95 transition-all flex items-center gap-1.5 shadow-cyan-500/30 uppercase tracking-widest"
                  >
                    {language === "bn" ? "প্লে নাউ" : "Play Now"}{" "}
                    <ChevronRight className="w-4 h-4 ml-1" />
                  </button>
